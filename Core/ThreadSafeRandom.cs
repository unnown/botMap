...
namespace AForge
{
    ...
    public sealed class ThreadSafeRandom : Random
    {
        ...
        {
            lock ( this.sync ) return base.Next( );
        }
        ...
        {
            lock ( this.sync ) return base.Next( maxValue );
        }
        ...
        {
            lock ( this.sync ) return base.Next( minValue, maxValue );
        }
        ...
        {
            lock ( this.sync ) base.NextBytes( buffer );
        }
        ...
        {
            lock ( this.sync ) return base.NextDouble( );
        }
    }
}
