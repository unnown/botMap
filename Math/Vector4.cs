...
namespace AForge.Math
{
    ...
    public struct Vector4
    {
        ...
        public float Max
        {
            get
            {
                var v1 = ( this.X > this.Y ) ? this.X : this.Y;
                var v2 = ( this.Z > this.W ) ? this.Z : this.W;
        ...
        {
            var norm = (float) System.Math.Sqrt(this.X * this.X + this.Y * this.Y + this.Z * this.Z + this.W * this.W );
