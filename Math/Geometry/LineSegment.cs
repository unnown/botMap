...
namespace AForge.Math.Geometry
{
    ...
    public sealed class LineSegment
    {
        ...
        public Point? GetIntersectionWith( Line other )
        {
            ...
            {
                if ( this.line.Intercept == other.Intercept ) throw new InvalidOperationException( "Segment is a portion of the specified line." );
        ...
        private ProjectionLocation LocateProjection( Point point )
        {
            ...
            */
            ...
            var abDelta = this.end - this.start;
            var acDelta = point - this.start;
