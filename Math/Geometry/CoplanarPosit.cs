...
namespace AForge.Math.Geometry
{
    ...
    public class CoplanarPosit
    {
        ...
        public void EstimatePose( Point[] points, out Matrix3x3 rotation, out Vector3 translation )
        {
            ...
            var error1 = this.Iterate( points, ref rotation1, ref translation1 );
            var error2 = this.Iterate( points, ref rotation2, ref translation2 );
        ...
        private float Iterate( Point[] points, ref Matrix3x3 rotation, ref Vector3 translation )
        {
            ...
            for ( var count = 0; count < 100; count++ )
            {
                ...
                var eps = ( this.modelVectors * rotation.GetRow( 2 ) ) / translation.Z + 1;
                // and new pose
                this.POS( points, eps, out rotation1, out rotation2, out translation1, out translation2 );

                // calculate error for both new poses
                var error1 = this.GetError( points, rotation1, translation1 );
                var error2 = this.GetError( points, rotation2, translation2 );
        ...
        private void POS( Point[] imagePoints, Vector3 eps, out Matrix3x3 rotation1, out Matrix3x3 rotation2, out Vector3 translation1, out Vector3 translation2 )
        {
            ...
            var I0Vector = this.modelPseudoInverse * imageXs;
            var J0Vector = this.modelPseudoInverse * imageYs;
            ...
            var temp = rotation1 * this.modelPoints[0];
