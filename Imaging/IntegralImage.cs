...
namespace AForge.Imaging
{
    ...
    public class IntegralImage
    {
        ...
        public int GetHaarXWavelet( int x, int y, int radius )
        {
            ...
            var a = this.GetRectangleSum( x, y1, x + radius - 1, y2 );
            var b = this.GetRectangleSum( x - radius, y1, x - 1, y2 );
        ...
        public float GetRectangleMean( int x1, int y1, int x2, int y2 )
        {
            ...
            return (float) ( (double) ( this.integralImage[y2, x2] + this.integralImage[y1, x1] - this.integralImage[y2, x1] - this.integralImage[y1, x2] ) /
                (double) ( ( x2 - x1 ) * ( y2 - y1 ) ) );
        }
