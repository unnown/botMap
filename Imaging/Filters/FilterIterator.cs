...
namespace AForge.Imaging.Filters
{
    ...
    public class FilterIterator : IFilter, IFilterInformation
    {
        ...
        public Bitmap Apply( Bitmap image )
        {
            ...
            // apply the filter
            var dstImage = this.Apply( imageData );
        ...
        {
            // initial iteration
            var dstImg = this.baseFilter.Apply( imageData );
            Bitmap tmpImg;
        ...
        {
            // initial iteration
            var dstImg = this.baseFilter.Apply( image );
        ...
        public void Apply( UnmanagedImage sourceImage, UnmanagedImage destinationImage )
        {
            ...
            {
                // initial iteration
                var dstImg = this.baseFilter.Apply( sourceImage );
                UnmanagedImage tmpImg;
