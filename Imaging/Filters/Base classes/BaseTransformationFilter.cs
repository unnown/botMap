...
namespace AForge.Imaging.Filters
{
    ...
    public abstract class BaseTransformationFilter : IFilter, IFilterInformation
    {
        ...
        public Bitmap Apply( BitmapData imageData )
        {
            ...
            var dstPixelFormat = this.FormatTranslations[imageData.PixelFormat];

            // get new image size
            var newSize = this.CalculateNewImageSize( new UnmanagedImage( imageData ) );
        ...
        public UnmanagedImage Apply( UnmanagedImage image )
        {
            ...
            // get new image size
            var newSize = this.CalculateNewImageSize( image );

            // create new destination image
            var dstImage = UnmanagedImage.Create( newSize.Width, newSize.Height, this.FormatTranslations[image.PixelFormat] );
        ...
        public void Apply( UnmanagedImage sourceImage, UnmanagedImage destinationImage )
        {
            ...
            // get new image size
            var newSize = this.CalculateNewImageSize( sourceImage );
