...
namespace AForge.Imaging.Filters
{
    ...
    public class Closing : IFilter, IInPlaceFilter, IInPlacePartialFilter, IFilterInformation
	{
        ...
        {
            var tempImage = this.dilatation.Apply( image );
            var destImage = this.errosion.Apply( tempImage );
        ...
        {
            var tempImage = this.dilatation.Apply( imageData );
            var destImage = this.errosion.Apply( tempImage );
        ...
        {
            var destImage = this.dilatation.Apply( image );
