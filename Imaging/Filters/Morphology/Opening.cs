...
namespace AForge.Imaging.Filters
{
    ...
    public class Opening : IFilter, IInPlaceFilter, IInPlacePartialFilter, IFilterInformation
    {
        ...
        {
            var tempImage = this.errosion.Apply( image );
            var destImage = this.dilatation.Apply( tempImage );
        ...
        {
            var tempImage = this.errosion.Apply( imageData );
            var destImage = this.dilatation.Apply( tempImage );
        ...
        {
            var destImage = this.errosion.Apply( image );
            this.dilatation.ApplyInPlace( destImage );
