...
namespace AForge.Imaging.Filters
{
    ...
    public class CanvasFill : BaseInPlaceFilter
    {
        ...
        protected override unsafe void ProcessFilter( UnmanagedImage image )
        {
            ...
            var startX = Math.Max( 0, this.region.X );
            var startY = Math.Max( 0, this.region.Y );
            ...
            var stopX = Math.Min( width, this.region.Right );
            var stopY = Math.Min( height, this.region.Bottom );
            ...
            if ( image.PixelFormat == PixelFormat.Format8bppIndexed )
            {
                ...
                {
                    AForge.SystemTools.SetUnmanagedMemory( ptr, this.fillGray , fillWidth );
                    ptr += stride;
                }
            }
            else
