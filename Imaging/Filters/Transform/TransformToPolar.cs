...
namespace AForge.Imaging.Filters
{
    ...
    public class TransformToPolar : BaseTransformationFilter
    {
        ...
        protected override unsafe void ProcessFilter( UnmanagedImage sourceData, UnmanagedImage destinationData )
        {
            ...
            // invert cirlce depth
            var circleDisform = 1 - this.circleDepth;
            ...
            var offsetAngleR = this.offsetAngle / 180 * Math.PI;
            if ( offsetAngleR < 0 )
            {
            ...
            var fillR = this.fillColor.R;
            var fillB = this.fillColor.B;
            var fillG = this.fillColor.G;
            var fillA = this.fillColor.A;
