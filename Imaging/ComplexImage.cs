...
namespace AForge.Imaging
{
    ...
    public class ComplexImage : ICloneable
    {
        ...
        public object Clone( )
        {
            ...
            var dstImage = new ComplexImage(this.width , this.height );
        ...
        {
            // create new image
            var dstImage = AForge.Imaging.Image.CreateGrayscaleImage(this.width , this.height );
            ...
            var offset = dstData.Stride - this.width;
            var scale = ( this.fourierTransformed ) ? Math.Sqrt(this.width * this.height ) : 1;
            ...
            unsafe
            {
                ...
                {
                    for ( var x = 0; x < this.width; x++, dst++ )
                    {
